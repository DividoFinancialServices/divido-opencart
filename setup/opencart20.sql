...
--
-- Host: magento20.divido.dev    Database: opencart_20
-- ------------------------------------------------------
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `opencart20`;
...
INSERT INTO `tst_api` VALUES (1,'1yOaFguIACcmMt2cLRN6mHnZIdsSzdQrRfHXC2fC58pIrhk3zy0b5d0E7iWwCmdU','','','',1,'2016-11-09 13:15:42','2016-11-09 13:15:42');
...
INSERT INTO `tst_currency` VALUES (1,'Pound Sterling','GBP','£','','2',0.80769998,1,'2016-11-09 13:16:41'),(2,'US Dollar','USD','$','','2',1.00000000,1,'2016-11-09 13:16:41'),(3,'Euro','EUR','','€','2',0.90700001,1,'2016-11-09 13:16:41');
...
--
-- Table structure for table `tst_customer_ban_ip`
--

DROP TABLE IF EXISTS `tst_customer_ban_ip`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tst_customer_ban_ip` (
...
--
-- Dumping data for table `tst_customer_ban_ip`
--

LOCK TABLES `tst_customer_ban_ip` WRITE;
/*!40000 ALTER TABLE `tst_customer_ban_ip` DISABLE KEYS */;
/*!40000 ALTER TABLE `tst_customer_ban_ip` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tst_extension` VALUES (23,'payment','cod'),(22,'total','shipping'),(57,'total','sub_total'),(58,'total','tax'),(59,'total','total'),(410,'module','banner'),(426,'module','carousel'),(390,'total','credit'),(387,'shipping','flat'),(349,'total','handling'),(350,'total','low_order_fee'),(389,'total','coupon'),(413,'module','category'),(408,'module','account'),(393,'total','reward'),(398,'total','voucher'),(407,'payment','free_checkout'),(427,'module','featured'),(419,'module','slideshow');
...
INSERT INTO `tst_user` VALUES (1,1,'admin','384a17ab3641ecdd7774db14f5dcc8e89dc8fec7','4b25cc9c2','John','Doe','youremail@example.com','','','172.16.224.1',1,'2016-11-09 13:15:42');
...
-- Dump completed on 2016-11-09 14:26:14
